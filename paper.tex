...
\caption{``Please rank the following sensors in how likely you believe they are to reveal what a person is thinking and feeling.'' Higher bars indicate higher rank, or more likely to reveal what one is thinking or feeling.''}
\end{figure*}

\section{Diversity and security of passthoughts}
\label{sec:orgdd2553c}
